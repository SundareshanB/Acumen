...
let ScenarioRepository = class ScenarioRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Scenario, dataSource);
    }
};
ScenarioRepository = tslib_1.__decorate([
