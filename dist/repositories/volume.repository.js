...
let VolumeRepository = class VolumeRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Volume, dataSource);
    }
};
VolumeRepository = tslib_1.__decorate([
